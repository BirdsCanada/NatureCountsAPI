...
| mobileId | String | No | UUID version 4 generated by the device for the checklist (e.g. 818356c1-9fe5-1f56-8b51-0e43a4deb9bc) |
| appVersion | String | No | Mobile App Version (e.g. 3.2.0 build 58) |
| OS | String | No | Information on the OS used by the device (e.g. Android 11 API 30) |
| device | String | No | Information on the device used, provided by the manufacturer (e.g. samsung SM-A326W) |
